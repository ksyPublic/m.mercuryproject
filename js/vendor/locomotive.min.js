                        ...
                        value: function (t) {
                            ...
                            Object.entries(this.els).forEach(function (r) {
                                var l = f(r, 2),
                                    ...
                                    c = l[1];
                                if (
                                    (!c || (c.inView && !t) || ("horizontal" === e.direction ? o >= c.left && n < c.right && e.setInView(c, a) : s >= c.top && i < c.bottom && e.setInView(c, a)),
                                    c && c.inView)
                                )
                ...
                polyfill: function () {
                    ...
                    function p(i, s, r) {
                        var a,
                            ...
                            d,
                            u = o();
                        i === e.body ? ((a = t), (c = t.scrollX || t.pageXOffset), (h = t.scrollY || t.pageYOffset), (d = n.scroll)) : ((a = i), (c = i.scrollLeft), (h = i.scrollTop), (d = l)),
                            f({ scrollable: a, method: d, startTime: u, startX: c, startY: h, x: s, y: r });
                    }
                },
            };
        }),
                                    ...
                                    Object.entries(this.sections).forEach(function (i) {
                                        ...
                                        n.persistent || (t.instance.scroll[t.directionAxis] > n.offset[t.directionAxis] && t.instance.scroll[t.directionAxis] < n.limit[t.directionAxis])
                                            ? ("horizontal" === t.direction ? t.transform(n.el, -t.instance.scroll[t.directionAxis], 0) : t.transform(n.el, 0, -t.instance.scroll[t.directionAxis]),
                                              n.inView ||
                                                  ((n.inView = !0), (n.el.style.opacity = 1), (n.el.style.pointerEvents = "all"), n.el.setAttribute("data-".concat(t.name, "-section-inview"), "")))
                                            : ((n.inView || e) &&
                                                  ((n.inView = !1), (n.el.style.opacity = 0), (n.el.style.pointerEvents = "none"), n.el.removeAttribute("data-".concat(t.name, "-section-inview"))),
                            ...
                            (this.els = {}),
                                ...
                                this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach(function (e, i) {
                                    ...
                                    null === l || l.inView
                                        ...
                                        : ((s = w.top - q(l.el).y - q(o).y), (n = w.left - q(l.el).x - q(o).x));
